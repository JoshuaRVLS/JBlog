...
import { upload, uploadMedia, uploadImage, uploadAvatar, uploadChatMedia, uploadDirectMessageMedia, uploadDirectMessageFile } from "../controllers/upload.controller";
...
router.post("/direct-message", requireAuth, uploadRateLimiter, uploadDirectMessageMedia.single("file"), uploadDirectMessageFile);

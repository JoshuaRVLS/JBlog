...
export function setupGroupChatHandlers(socket: Socket): void {
  ...
  socket.on("send-message", async (data: { 
    ...
    try {
      ...
      // Create notifications for mentions (async, non-blocking)
      Promise.all(
      ...
      // Update group chat timestamp (async, non-blocking)
      db.groupChat.update({
        where: { id: groupId },
